...
var containerNmae = 'aacontainer';
// 
console.log(blobURI);
var blobService = AzureStorage.createBlobServiceWithSas(blobURI, SASToken);
function fn(containerNmae, blobName, cb) {
  blobService.getBlobToText(containerNmae, blobName, function (err, res) {
    // if (!err) {
    //   console.log(res);
    // }
    test = "abc";
